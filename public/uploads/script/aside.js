...
$(document).ready(function () {
    ...
    $window.scroll(function (event) {
        ...
        if (st > 0 && st < max_scroll && $aside.height() > window_height && $aside.height()+100 < $('#content').height()){
            ...
            //if ( action_block_header.css("display") != "block" && $aside.hasClass("frozen") == true){
            //    if (st >= top + action_block_aside.position().top + action_block_aside.height()  ){
            //        action_block_header.fadeIn(500);
            //    }
            //
            //}

            //if ( action_block_header.css("display") != "none" && $aside.hasClass("frozen") == true ){
            //    if ( st <= top + action_block_aside.position().top + action_block_aside.height() ){
            //        action_block_header.hide();
            //    }
            //}
